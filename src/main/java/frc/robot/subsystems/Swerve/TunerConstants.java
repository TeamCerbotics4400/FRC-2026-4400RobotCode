...
/**
 * Swerve hardware definition: CAN IDs, gear ratios, encoder offsets, module positions and gains.
 * Regenerated by Tuner X, so avoid hand editing anything other than the tuned values.
 */
public class TunerConstants {
  ...
  private static final Current kSlipCurrent = Amps.of(130);
  ...
  // Per-module constants. XPos/YPos are the wheel position relative to the robot center:
  // +X forward, +Y left. The encoder offset is the CANcoder reading when the wheel points forward.

  // Front Left
  private static final int kFrontLeftDriveMotorId = 1;
  private static final int kFrontLeftSteerMotorId = 2;
  private static final int kFrontLeftEncoderId = 3;
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.21240234375);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(0.125732421875);
  ...
  // Module constants built from the values above. Order matters: FL, FR, BL, BR.
